...
object RequestConst {
    ...
    const val OPEN_EYE_URL = "https://baobab.kaiyanapp.com/api/"

    //开眼接口2
    const val OPEN_EYE_SUB_URL = "http://api.eyepetizer.net/"

    //百度接口 访问链接
    const val BAI_DU_URL = "https://top.baidu.com/api/"

    //每日微语
    const val ZAO_BAO_URL =
        "https://api.suxun.site/"//https://xzdx.top/api/ https://60s-api-cf.viki.moe/
